...
public class HoaDon {
	 ...
	 * @return the gioHat
	 */
	public int getGioHat() {
		return (int) ((thoiGianKetThuc.getTime() - thoiGianBatDau.getTime()) / 1000 / 60/ 60);
	}
	/**
	...
	public String toString() {
		return "HoaDon [maHoaDon=" + maHoaDon + ", khachHang=" + khachHang + ", phong=" + phong + ", nhanVien="
				+ nhanVien + ", ngayLapHoaDon=" + ngayLapHoaDon + ", thoiGianBatDau=" + thoiGianBatDau
				+ ", thoiGianKetThuc=" + thoiGianKetThuc + ", dsChiTietHoaDon=" + dsChiTietHoaDon + ", donGiaPhong="
				+ donGiaPhong + ", tongTien=" + tongHoaDon + "]";
	}
}
