...
//                    loadDataChart();
    ...
    private void initComponents() {
        ...
        if (tblSPBanChay.getColumnModel().getColumnCount() > 0) {
            ...
            tblSPBanChay.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        tblPhanTram.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Loại dịch vụ", "Số lượng tiêu thụ", "Chiếm(%)", "Tổng trị giá"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        if (tblPhanTram.getColumnModel().getColumnCount() > 0) {
            tblPhanTram.getColumnModel().getColumn(0).setResizable(false);
            tblPhanTram.getColumnModel().getColumn(1).setResizable(false);
            tblPhanTram.getColumnModel().getColumn(2).setResizable(false);
            tblPhanTram.getColumnModel().getColumn(3).setResizable(false);
        }
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtTongSPBanChay, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap())
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(chart, javax.swing.GroupLayout.DEFAULT_SIZE, 519, Short.MAX_VALUE))
        );
