...
public class Menu extends JPanel {
	...
	private void buidMenu() {
		setLayout(new MigLayout("wrap, fillx, insets 0", "0[fill]0", "[]0[]0[]"));
		setBackground(new Color(35, 35, 35));
		setOpaque(false);
		add(createPaneName(), "h 80!");
		add(createPane(), "h 720!");
	}
	
	private JPanel createPaneName() {
		JPanel paneName = new JPanel();
		paneName.setOpaque(false);
//		JLabel name = new JLabel("KARAOKE FOURH");
//		name.setIcon(new ImageIcon(getClass().getResource("/icon/microphone_80px.png")));
