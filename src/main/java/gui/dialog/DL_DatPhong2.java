...
public class DL_DatPhong2 extends javax.swing.JDialog {
    ...
    public DL_DatPhong2(java.awt.Frame parent) {
        super(parent, true);
...
//        time
        ...
        thoiGianBatDau.addDateTimeChangeListener((var event) -> {
            try {
                ...
                Logger.getLogger(DL_DatPhong2.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
